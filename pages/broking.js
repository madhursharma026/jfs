        ...
        <>
            ...
            <div className="m-3 m-lg-5">
                <div className={`container-lg px-md-5 px-4 py-5 ${styles.containerStyle}`}>
                    <div className='text-white pt-md-5 pb-md-5 mb-md-5' style={{ maxWidth: '650px' }}>
                        <h1 className='pt-md-3' style={{ fontSize: 'calc(36px + 1.25vw)', fontWeight: '900' }}><b>Get insured, stay assured</b></h1>
                ...
                <div className="row">
                    ...
                    <div className="col-md-6 px-lg-5" style={{ margin: 'auto' }}>
                        <div className="px-xl-3 pt-md-0 pt-3">
                            <h2 style={{ fontWeight: '900' }}><b>Insurance plans at your fingertips</b></h2>
                ...
                <div className="row">
                    ...
                    <div className="col-md-6 px-lg-5" style={{ margin: 'auto' }}>
                        <div className="px-xl-3 pt-lg-0 pt-3">
                            <h2 style={{ fontWeight: '900' }}><b>Multiple plans under one roof</b></h2>
            ...
            <div className="my-5 px-5" style={{ maxWidth: '1200px', margin: 'auto' }}>
                <div className="row">
                    ...
                    <div className="col-md-6 px-lg-5" style={{ margin: 'auto' }}>
                        <div className="px-xl-3 pt-md-0 pt-3">
                            <h2 style={{ fontWeight: '900' }}><b>With you every step of the way</b></h2>
            ...
            <div className="my-5 px-3" style={{ maxWidth: '1200px', margin: 'auto' }}>
                ...
                <Accordion className='mt-4'>
                    <Accordion.Item eventKey="0" style={{ borderTop: '0', borderLeft: '0', borderRight: '0' }}>
                        <Accordion.Header><b>Why do I need car insurance?</b></Accordion.Header>
                        <Accordion.Body>
                            In India, having third-party car insurance is mandatory. Additionally, you need a protective shield for yourself and your loved ones so that any financial loss or damages caused by accidents are compensated. In such cases, the insurance provider will cover your damages.
                        </Accordion.Body>
                    </Accordion.Item>
                    <Accordion.Item eventKey="1" style={{ borderTop: '0', borderLeft: '0', borderRight: '0' }}>
                        <Accordion.Header><b>What are the benefits of buying car insurance online?</b></Accordion.Header>
                        <Accordion.Body>
                            One of the main benefits of purchasing auto insurance online is that there is no paperwork or proof required. Additionally, you have a variety of payment alternatives.
                        </Accordion.Body>
                    </Accordion.Item>
                    <Accordion.Item eventKey="3" style={{ borderTop: '0', borderLeft: '0', borderRight: '0' }}>
                        <Accordion.Header><b>How quickly can I buy a car insurance policy online</b></Accordion.Header>
                        <Accordion.Body>
                            It takes only a few minutes to purchase car insurance online. Simply, enter the necessary information, get quotes as per your needs from multiple insurers, and make the payment. A copy of your car insurance policy will be sent to your email address immediately.
                        </Accordion.Body>
                    </Accordion.Item>
                    <Accordion.Item eventKey="4" style={{ borderTop: '0', borderLeft: '0', borderRight: '0' }}>
                        <Accordion.Header><b>Do I need to have a valid insurance policy to get my new vehicle registered?</b></Accordion.Header>
                        <Accordion.Body>
                            Yes, you must have a car insurance policy to get your vehicle registered. As per the Motor Vehicles Act, you must have a mandatory third-party insurance policy.
                        </Accordion.Body>
                    </Accordion.Item>
                    <Accordion.Item eventKey="5" style={{ borderTop: '0', borderLeft: '0', borderRight: '0' }}>
                        <Accordion.Header><b>Are offline and online car insurance policies the same?</b></Accordion.Header>
                        <Accordion.Body>
                            Yes, both are the same. One of the benefits of online insurance is that a copy of the policy is sent directly to your registered email address after the payment is successfully done.
                        </Accordion.Body>
                    </Accordion.Item>
                </Accordion>
            </div>
