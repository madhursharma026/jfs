    ...
    return (
        <>
            ...
            <div className="text-md-center px-3 container-lg" style={{ maxWidth: '1200px', margin: 'auto' }}>
                <h1 className='mt-5' style={{ fontSize: 'calc(40px + 1.25vw)', fontWeight: '900' }}><b>Board of Directors</b></h1>
                <h5 style={{fontWeight: '500', fontSize: '1.125rem'}}>Meet our Board of Directors who share a unified vision and provide unwavering support to the success and growth of the organisation.</h5>
                <div className="row">
                    <div className={`col-md-4 col-sm-6 col-12 p-5 text-center`}>
                        ...
                        <h4 style={{fontWeight: '900'}}><b>Mr. Kundapur Vaman Kamath</b></h4>
                    ...
                    <div className={`col-md-4 col-sm-6 col-12 p-5 text-center`}>
                        ...
                        <h4 style={{fontWeight: '900'}}><b>Mr. Rajiv Mehrishi</b></h4>
                    ...
                    <div className={`col-md-4 col-sm-6 col-12 p-5 text-center`}>
                        ...
                        <h4 style={{fontWeight: '900'}}><b>Mr. Sunil Mehta</b></h4>
                        <h6>Independent Director</h6>
                    </div>
                    <div className={`col-md-4 col-sm-6 col-12 p-5 text-center`}>
                    ...
                    <div className={`col-md-4 col-sm-6 col-12 p-5 text-center`}>
                        ...
                        <h4 style={{fontWeight: '900'}}><b>Mr. Jagannatha Kuma</b></h4>
                        <h6>Non-Independent and Non-Executive Director</h6>
                    </div>
                    <div className={`col-md-4 col-sm-6 col-12 p-5 text-center`}>
                        ...
                        <h4 style={{fontWeight: '900'}}><b>Ms. Jayashri Rajesh</b></h4>
