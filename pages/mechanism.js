    ...
    return (
        <>
            ...
            <div className="container-lg" style={{ maxWidth: '1200px', margin: 'auto' }}>
                <h1 className='text-center mt-5' style={{ fontSize: 'calc(40px + 1.25vw)' }}><b>Grievance Management</b></h1>
                <h5 className='text-secondary text-center'>The clear framework of our grievance handling mechanism ensures quick redressing of stakeholders grievances related to policies.</h5>
                <div className="row mt-5">
                    <div className="col-lg-6">
                        <h1 style={{ fontSize: 'calc(40px + 1.25vw)' }}><b>Grievance Handling Mechanism</b></h1>
